# Метод главных компонент (principal component analysis) - алгоритм обучения БЕЗ учителя.
...
# В PCA выполняется качественная оценка этой зависимости путем поиска главных осей координат и их использования
